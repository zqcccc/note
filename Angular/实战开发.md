...
2. 创建应用：`ng new angular-test --minimal --inlineTemplate false`
   ...
   ![不加minimal生成的文件结构](../media/不加minimal生成的文件结构.png)

   

   ![加了minimal生成的文件结构](../media/加了minimal生成的文件结构.png)


​	![单独模板文件目录](../media/单独模板文件目录.png)
...
![platformBrowserDynamic获取的平台实例对象](../media/platformBrowserDynamic获取的平台实例对象.png)
