...
type Baked<T> = T extends Beef ? StoneBaked<T> : T extends Fish ? FireBaked<T> : StoneBaked<T>;

let b: Baked<Beef>; // b 有stoneTemperature属性
let f: Baked<Fish>; // f 有fireTemperature属性
let l: Baked<Lamb>; // l 有stoneTemperature属性
```
